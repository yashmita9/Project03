<%@page import="in.co.rays.project_3.controller.InitiativeCtl"%>
					...
					<div class="card">
						<div class="card-body">
							<%
								...
								if (dto.getId() != null) {
							%>
							<h3 class="text-center text-primary">Update Initiative</h3>
							<%
								} else {
							%>
							<h3 class="text-center text-primary">Add Initiative</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" id="datepicker2" name="startDate"
											class="form-control" placeholder="Date Of Start"
											readonly="readonly"
								...
								<span class="pl-sm-5"><b>Version Number</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" name="versionNumber" class="form-control"
											...
											value="<%=DataUtility.getStringData(dto.getVersionNumber())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("versionNumber", request)%></font><br>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=InitiativeCtl.OP_UPDATE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=InitiativeCtl.OP_CANCEL%>">
							</div>
							<%
								} else {
							%>
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=InitiativeCtl.OP_RESET%>">
							</div>
							<%
								}
							%>
