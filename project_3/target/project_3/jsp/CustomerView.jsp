...
<body class="p4">
	...
	<span class="pl-sm-5"><b>clients Name</b>
      ...
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="clientName" placeholder="Client Name" value="<%=DataUtility.getStringData(dto.getClienName())%>">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("clientName", request)%></font></br>			
	
	<span class="pl-sm-5"><b>Location</b>
	<span style="color: red;">*</span></span></br> 
    <div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" class="form-control" name="location" placeholder="Location" value="<%=DataUtility.getStringData(dto.getLocation())%>">
      </div>
    </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
       ...
       <input type="text" name="importance" class="form-control" placeholder="Importance"
									value="<%=DataUtility.getStringData(dto.getImportance())%>">
      </div>
    </div>
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("emailId", request)%></font></br>
	
	<span class="pl-sm-5"><b>Contact No</b>
	<span style="color: red;">*</span></span> </br>
	<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" class="form-control" id="defaultForm-email" maxlength="10" name="contactNo"placeholder="Contact No" value="<%=DataUtility.getStringData(dto.getContactNo())%>">
      </div>
    </div>							
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("contactNo", request)%></font></br>
